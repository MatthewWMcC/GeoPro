import { AddPlayerType, ClearDataType, DeletePlayerType, GameDataActionTypes, GameDataState, GameViewStates, InitRoomDataType, NewAdminType, player, SetGameViewType } from "./types"
...
export const AddPlayer = (player: player): AddPlayerType => {
    return {
...
export const SetGameViewState = (GameViewState: GameViewStates): SetGameViewType => {
    return {
