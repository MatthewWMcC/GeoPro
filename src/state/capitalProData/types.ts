...
export type CapitalProDataActions = InitRoomDataCapitalType | AddPlayerCapitalType | DeletePlayerCapitalType | RemoveInGameDataCapitalType
| NewLocationCapitalType | UpdateGuessLimitCapitalType | UpdateBestMapGuessCapitalType | SetCurrentMapGuessCapitalType | UpdateCountdownCapitalType | 
UpdateRoundEndCountdownCapitalType |
UpdateMaxCountdownCapitalType | GameEndCapitalType | UpdateResultNumCapitalType | RoundEndSetupCapitalType | GameStartDataCapitalType | NewRoundDataCapitalType |
UpdatePlayerGuessNumCapitalType | SetViewStateType | ClearDataCapitalType;
