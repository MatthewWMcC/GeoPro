import { AddPlayerCapitalType, CapitalProDataActions, CapitalProDataActionTypes, CapitalProState, capitialProViewStates, DeletePlayerCapitalType, GameEndCapitalType, GameStartDataCapitalType, InitRoomDataCapitalType, NewLocationCapitalType, NewRoundDataCapitalType, RemoveInGameDataCapitalType, RoundEndSetupCapitalType, SetCurrentMapGuessCapitalType, SetViewStateType, UpdateBestMapGuessCapitalType, UpdateCountdownCapitalType, UpdateGuessLimitCapitalType, UpdateMaxCountdownCapitalType, UpdatePlayerGuessNumCapitalType, UpdateResultNumCapitalType, UpdateRoundEndCountdownCapitalType } from "./types"
...
const initCapitalProState: CapitalProState = {
    ...
    guessLimit: 3,
    roundEndCountdown: 0,
    viewState: capitialProViewStates.LOADING
} 

export const CapitalProDataReducer = (state: CapitalProState = initCapitalProState, action: CapitalProDataActions) : CapitalProState => {
    switch(action.type) {
...
const InitRoomDataReducer = (state: CapitalProState, action: InitRoomDataCapitalType): CapitalProState => {
    return({
        ...state,
...
const AddPlayerReducer = (state: CapitalProState, action: AddPlayerCapitalType): CapitalProState => {
    return({
        ...state,
...
const DeletePlayerReducer = (state: CapitalProState, action: DeletePlayerCapitalType): CapitalProState => {
    return({
        ...state,
        playerList: state.playerList.filter(player => player.socketId !== action.payload.userId)
    })
}


const UpdateCountdownReducer = (state: CapitalProState, action: UpdateCountdownCapitalType): CapitalProState => {
    return({
        ...state,
...
const UpdateRoundEndCountdownReducer = (state: CapitalProState, action: UpdateRoundEndCountdownCapitalType): CapitalProState => {
    return({
        ...state,
...
const UpdateResultNumReducer = (state: CapitalProState, action: UpdateResultNumCapitalType): CapitalProState => {
    return({
        ...state,
...
const UpdateMaxCountdownReducer = (state: CapitalProState, action: UpdateMaxCountdownCapitalType): CapitalProState => {
    return({
        ...state,
...
const UpdateGuessLimitReducer = (state: CapitalProState, action: UpdateGuessLimitCapitalType): CapitalProState => {
    return({
        ...state,
...
const UpdateBestGuessReducer = (state: CapitalProState, action: UpdateBestMapGuessCapitalType): CapitalProState => {
    return({
        ...state,
...
const SetCurrentMapGuessReducer = (state: CapitalProState, action: SetCurrentMapGuessCapitalType): CapitalProState => {
    return({
        ...state,
...
const UpdatePlayerGuessNumReducer = (state: CapitalProState, action: UpdatePlayerGuessNumCapitalType): CapitalProState => {
    return({
        ...state,
...
const RemoveInGameDataReducer = (state: CapitalProState, action: RemoveInGameDataCapitalType): CapitalProState => {
    return ({
        ...state,
...
const GameStartReducer = (state: CapitalProState, action: GameStartDataCapitalType): CapitalProState => {
    return ({
        ...state,
        playerList: action.payload.playerList,
        viewState: action.payload.viewState,
...
const GameEndReducer = (state: CapitalProState, action: GameEndCapitalType): CapitalProState => {
    return ({
        ...state,
        viewState: action.payload.viewState
    })
...
const SetViewStateReducer = (state: CapitalProState, action: SetViewStateType): CapitalProState => {
    return ({
        ...state,
        viewState: action.payload.viewState
    })
...
const NewRoundDataReducer = (state: CapitalProState, action: NewRoundDataCapitalType): CapitalProState => {
    return ({
        ...state,
        countdown: action.payload.countdown, 
        roundNumber: action.payload.roundNumber, 
...
const NewLocationDataReducer = (state: CapitalProState, action: NewLocationCapitalType): CapitalProState => {
    return ({
        ...state,
        locationData: action.payload.locationData
    })
...
const RoundEndModalSetupReducer = (state: CapitalProState, action: RoundEndSetupCapitalType): CapitalProState => {
    return ({
        ...state,
        viewState: action.payload.viewState, 
        playerList: action.payload.playerList, 
