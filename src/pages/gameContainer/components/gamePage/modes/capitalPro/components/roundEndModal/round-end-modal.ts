...
export const RoundEndModal: m.Component<RoundEndModalAttrs, RoundEndModalState> = {
                ...
                m("#round-end-body-container", [
                    m("#map-half", [
                        m("#your-distance-container", [
                            m("label#your-distance-label", playerDistancekm ? `Your guess was ${playerDistancekm}km away and you gained ${addedScore} points!` : "You did not make a guess :(")
                        ]),
